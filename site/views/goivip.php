    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="staticBackdropLabel1">Thanh toán Gói Vip</h5>
            ...
            <div class="modal-body">
                ...
                <form action="../vnpay_php/vnpay_create_payment.php" id="create_form" method="post">
                    ...
                    <div class="form-group">
                        <input class="form-control" id="amount" name="amount" type="hidden" value="300000">
                    </div>
                    <div class="form-group">
                        <textarea style="display:none;" class="form-control" cols="20" id="order_desc" name="order_desc" rows="2">Thanh toán Gói Vip</textarea>
                    </div>
                    <div class="form-group">
